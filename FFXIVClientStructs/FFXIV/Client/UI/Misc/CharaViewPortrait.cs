...
public unsafe partial struct CharaViewPortrait {
    ...
    [MemberFunction("48 89 5C 24 ?? 57 48 83 EC ?? 8B 51 ?? 48 8B D9 0F 29 74 24 ?? 48 8D 0D ?? ?? ?? ?? 0F 29 7C 24 ?? 0F 28 F2 0F 28 F9 E8 ?? ?? ?? ?? 48 8B F8 48 85 C0 74 ?? 8B 53 ?? 48 8D 0D ?? ?? ?? ?? E8 ?? ?? ?? ?? 48 85 C0 74 ?? F6 80 ?? ?? ?? ?? ?? 74 ?? 48 8D 98 ?? ?? ?? ?? 33 D2 48 8B CB E8 ?? ?? ?? ?? 48 8B CB E8 ?? ?? ?? ?? 48 8D 8F ?? ?? ?? ?? 0F 28 D6 0F 28 CF E8 ?? ?? ?? ?? 48 8B 5C 24 ?? 0F 28 74 24 ?? 0F 28 7C 24 ?? 48 83 C4 ?? 5F C3 CC CC CC CC CC CC CC CC CC CC CC CC CC CC CC 48 89 5C 24 ?? 57 48 83 EC ?? 8B 51 ?? 48 8B D9 48 8D 0D ?? ?? ?? ?? E8 ?? ?? ?? ?? 48 8B F8 48 85 C0 74 ?? 8B 53 ?? 48 8D 0D ?? ?? ?? ?? E8 ?? ?? ?? ?? 48 85 C0 74 ?? F6 80 ?? ?? ?? ?? ?? 74 ?? 48 8D 98 ?? ?? ?? ?? 33 D2 48 8B CB E8 ?? ?? ?? ?? 48 8B CB E8 ?? ?? ?? ?? 48 8D 8F ?? ?? ?? ?? E8 ?? ?? ?? ?? 48 8B 5C 24 ?? 48 83 C4 ?? 5F C3 CC CC CC CC CC CC CC CC CC CC CC CC CC CC CC 48 89 5C 24")]
