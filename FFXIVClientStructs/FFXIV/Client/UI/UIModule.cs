...
[StructLayout(LayoutKind.Explicit, Size = 0xFFBA0 - 0x10)]
...
public unsafe partial struct UIModule {
    ...
    [FieldOffset(0xFD010 - 0x10)] internal InfoModule InfoModule;
    [FieldOffset(0xFEC88 - 0x10)] internal UIModuleHelpers UIModuleHelpers;
    [FieldOffset(0xFECD8 - 0x10)] public Utf8String AddonSheetName;

    [FieldOffset(0xFED48 - 0x10)] public Utf8String UIColorSheetName;

    [FieldOffset(0xFEDC0 - 0x10)] public Utf8String CompletionSheetName;
    [FieldOffset(0xFEE28 - 0x10)] public Utf8String CompletionOpenIconMacro;
    [FieldOffset(0xFEE90 - 0x10)] public Utf8String CompletionCloseIconMacro;
    [FieldOffset(0xFEEF8 - 0x10)] public Utf8String NewLineMacro;
    [FieldOffset(0xFEF60 - 0x10)] public Utf8String LastTalkName;
    [FieldOffset(0xFEFC8 - 0x10)] public Utf8String LastTalkText;
    [FieldOffset(0xFF030 - 0x10)] internal UIInputData UIInputData;
    [FieldOffset(0xFFA60 - 0x10)] internal UIInputModule UIInputModule;
    // [FieldOffset(0xF7BA8 - 0x10)] public Vf79Struct;
